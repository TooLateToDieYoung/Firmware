...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOB, SSE_Pin | SSD_Pin | SSP_Pin | SSC_Pin | SSG3_Pin | SSG2_Pin | SSG1_Pin | SSB_Pin | SSF_Pin | SSA_Pin | SSG_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = SSE_Pin | SSD_Pin | SSP_Pin | SSC_Pin | SSB_Pin | SSF_Pin | SSA_Pin | SSG_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_OPENDRAIN;
  ...
  /**/
  GPIO_InitStruct.Pin = SSG3_Pin | SSG2_Pin | SSG1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_OPENDRAIN;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = SWFD_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_FLOATING;
  LL_GPIO_Init(SWFD_GPIO_Port, &GPIO_InitStruct);
}
