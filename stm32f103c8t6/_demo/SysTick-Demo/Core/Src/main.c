...
void SystemClock_Config(void)
{
  ...
  LL_Init1msTick(9000000); /*
		The SysTick calibration value is fixed to 9000, 
		which gives a reference time base of 1 ms 
		with the SysTick clock set to 9MHz (max HCLK/8).
		Check to <(EN) Refs Manual - stm32f10xxx.pdf> page 169.
	*/
