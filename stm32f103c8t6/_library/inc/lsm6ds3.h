 ...
 */
typedef enum {
	WHO_AM_I = 0x0F, CTRL_ACCE, CTRL_GYRO, 
	STATUS_R = 0x1E,
	GYRO_X_L = 0x22, GYRO_X_H, GYRO_Y_L, GYRO_Y_H, GYRO_Z_L, GYRO_Z_H,
	ACCE_X_L = 0x28, ACCE_X_H, ACCE_Y_L, ACCE_Y_H, ACCE_Z_L, ACCE_Z_H
...
typedef struct {
  ...
  struct {
    GPIO_TypeDef * GPIOx; // GPIOx peripheral
    uint16_t       pin;   // pin offset
  } CS; // * SPI CS wire for selecting the slave device
