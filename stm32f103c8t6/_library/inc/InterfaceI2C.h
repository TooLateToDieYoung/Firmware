...
#include "Common.h" // ask for some useful tools & typedef
  ...
  static inline task_t _InterfaceI2C_Stop(I2C_TypeDef *I2Cx, bool_t isAfterTx)
  {
    ...
    if (isAfterTx && !_MASK(I2C1->SR1, _BIT(2)))
      return Fail;
